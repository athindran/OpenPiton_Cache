...
// Note that the belows were generated through the template file and pyhp
    ...
    `define ARIANE_CORE0     `TILE0.g_core.core.ariane
    `define SPARC_CORE0      `TILE0.g_core.core
    `define PICO_CORE0       `TILE0.g_core.core
    `define CCX_TRANSDUCER0  `TILE0.g_core.ccx_l15_transducer
    `define PICO_TRANSDUCER0 `TILE0.g_core.pico_l15_transducer
