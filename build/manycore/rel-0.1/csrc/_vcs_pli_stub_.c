...
/* PLI routine: $monInit:call */
#ifndef __VCS_PLI_STUB_monInit_call
#define __VCS_PLI_STUB_monInit_call
extern void monInit_call(int data, int reason);
#pragma weak monInit_call
void monInit_call(int data, int reason)
{
    ...
    if (!_vcs_pli_stub_initialized_) {
        ...
        _vcs_pli_fp_ = (void (*)(int data, int reason)) dlsym(RTLD_NEXT, "monInit_call");
        if (_vcs_pli_fp_ == NULL) {
            _vcs_pli_fp_ = (void (*)(int data, int reason)) VCS_dlsymLookup("monInit_call");
        }
    }
    if (_vcs_pli_fp_) {
        _vcs_pli_fp_(data, reason);
    } else {
        vcsMsgReportNoSource1("PLI-DIFNF", "monInit_call");
    }
}
void (*__vcs_pli_dummy_reference_monInit_call)(int data, int reason) = monInit_call;
#endif /* __VCS_PLI_STUB_monInit_call */

/* PLI routine: $monInit:check */
#ifndef __VCS_PLI_STUB_monInit_check
#define __VCS_PLI_STUB_monInit_check
extern void monInit_check(int data, int reason);
#pragma weak monInit_check
void monInit_check(int data, int reason)
{
    ...
    if (!_vcs_pli_stub_initialized_) {
        _vcs_pli_stub_initialized_ = 1;
        _vcs_pli_fp_ = (void (*)(int data, int reason)) dlsym(RTLD_NEXT, "monInit_check");
        if (_vcs_pli_fp_ == NULL) {
            _vcs_pli_fp_ = (void (*)(int data, int reason)) VCS_dlsymLookup("monInit_check");
        }
    }
    if (_vcs_pli_fp_) {
        _vcs_pli_fp_(data, reason);
...
void (*__vcs_pli_dummy_reference_monInit_check)(int data, int reason) = monInit_check;
#endif /* __VCS_PLI_STUB_monInit_check */

/* PLI routine: $parse:call */
#ifndef __VCS_PLI_STUB_parse_call
#define __VCS_PLI_STUB_parse_call
extern void parse_call(int data, int reason);
#pragma weak parse_call
void parse_call(int data, int reason)
{
    ...
    if (!_vcs_pli_stub_initialized_) {
        _vcs_pli_stub_initialized_ = 1;
        _vcs_pli_fp_ = (void (*)(int data, int reason)) dlsym(RTLD_NEXT, "parse_call");
        if (_vcs_pli_fp_ == NULL) {
            _vcs_pli_fp_ = (void (*)(int data, int reason)) VCS_dlsymLookup("parse_call");
        }
    }
    if (_vcs_pli_fp_) {
        _vcs_pli_fp_(data, reason);
    } else {
        vcsMsgReportNoSource1("PLI-DIFNF", "parse_call");
    }
}
void (*__vcs_pli_dummy_reference_parse_call)(int data, int reason) = parse_call;
#endif /* __VCS_PLI_STUB_parse_call */

/* PLI routine: $parse:check */
#ifndef __VCS_PLI_STUB_parse_check
#define __VCS_PLI_STUB_parse_check
extern void parse_check(int data, int reason);
#pragma weak parse_check
void parse_check(int data, int reason)
{
    ...
    if (!_vcs_pli_stub_initialized_) {
        _vcs_pli_stub_initialized_ = 1;
        _vcs_pli_fp_ = (void (*)(int data, int reason)) dlsym(RTLD_NEXT, "parse_check");
        if (_vcs_pli_fp_ == NULL) {
            _vcs_pli_fp_ = (void (*)(int data, int reason)) VCS_dlsymLookup("parse_check");
        }
    }
    if (_vcs_pli_fp_) {
        _vcs_pli_fp_(data, reason);
...
void (*__vcs_pli_dummy_reference_parse_check)(int data, int reason) = parse_check;
#endif /* __VCS_PLI_STUB_parse_check */
